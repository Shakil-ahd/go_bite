...
class EnhancedMapPainter extends CustomPainter {
  ...
  EnhancedMapPainter({required this.riderLocation, required this.orderStatus});
  ...
  void _drawAbstractMap(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromLTRBR(30, 30, 120, 100, const Radius.circular(8)),
      blockPaint,
    );
    canvas.drawRRect(
      RRect.fromLTRBR(
    ...
    canvas.drawRRect(
      RRect.fromLTRBR(200, 100, 280, 220, const Radius.circular(8)),
      buildingPaint,
    );
    canvas.drawRRect(
      RRect.fromLTRBR(80, 250, 180, 320, const Radius.circular(8)),
      buildingPaint,
    );
    ...
    _drawLandmarkLabel(
      canvas,
      'Residential Area',
      Offset(size.width - 140, size.height - 150),
    );
  }
  ...
  void _drawEnhancedMarker(
    ...
    labelPainter.paint(
      canvas,
      Offset(pos.dx - labelPainter.width / 2, pos.dy + 22),
    );
  }
